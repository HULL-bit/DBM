...
router.register(r'conservatoire/albums', views.AlbumPhotoViewSet, basename='albumphoto')
router.register(r'conservatoire/photos', views.PhotoViewSet)
router.register(r'conservatoire/kourels', views.KourelViewSet)
router.register(r'conservatoire/seances', views.SeanceConservatoireViewSet, basename='seanceconservatoire')
